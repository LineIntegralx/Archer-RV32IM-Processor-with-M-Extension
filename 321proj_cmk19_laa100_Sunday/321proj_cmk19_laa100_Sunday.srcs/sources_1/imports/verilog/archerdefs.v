...
//architectural constants - added by Claritta & Lynn
`define CONTROLOPS_SIZE 3

//CONTROL operations - added by Claritta & Lynn
`define CONTROL_OP_MUL 3'b000
`define CONTROL_OP_MULH 3'b001
`define CONTROL_OP_MULHSU 3'b010
`define CONTROL_OP_MULHU 3'b011
`define CONTROL_OP_DIV 3'b100
`define CONTROL_OP_DIVU 3'b101
`define CONTROL_OP_REM 3'b110
`define CONTROL_OP_REMU 3'b111
